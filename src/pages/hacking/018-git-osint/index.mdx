...
Some users enable that privacy option. In that case, you will notice an email that looks something like this: username@users.noreply.github.com <br/>
# In that case you should try enumerating more commits.
Older commits especially the first ones have a greater chance to yield information.

...
- <Link to='/docs/v1/SDK/data'>Data</Link> - Fetches EasySec data from the blockchain
...
- <Link to='/docs/v1/SDK/transact'>Transact</Link> - Prepares computed trades for execution against EasySec smart contracts

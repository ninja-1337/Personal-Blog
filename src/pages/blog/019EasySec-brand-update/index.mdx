...
Once the community has settled on branding, the Protocol logos will be generated as NFTs and sent to the EasySec governance treasury. Community members may use the logos as they see fit under the rights set out by Uniswap Labs’ [Trademark Guidelines](https://uniswap.org/trademarks/).
